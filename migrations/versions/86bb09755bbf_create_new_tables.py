...
Revision ID: 86bb09755bbf
Revises: 
Create Date: 2024-10-27 00:56:49.443990
...
def upgrade() -> None:
    ...
    sa.Column('criado_em', sa.DateTime(), nullable=False),
    sa.Column('atualizado_em', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['id_categoria'], ['categories.id'], ),
    sa.ForeignKeyConstraint(['id_organizacao'], ['organizations.id'], ),
    sa.ForeignKeyConstraint(['id_usuario'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('criado_em', sa.DateTime(), nullable=False),
    sa.Column('atualizado_em', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['id_ong'], ['organizations.id'], ),
    sa.ForeignKeyConstraint(['id_organizacao'], ['organizations.id'], ),
